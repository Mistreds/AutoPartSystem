...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.BackInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GoodsInvoiceId");

                    b.ToTable("BackInvoice");
                });
            ...
            modelBuilder.Entity("Data.Expenses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Goods", b =>
                {
                    ...
                    b.Property<int>("InputAktau")
                        .HasColumnType("int");

                    b.Property<int>("InputAstana")
                        .HasColumnType("int");

                    b.Property<int>("InputPrice")
                        .HasColumnType("int");

                    b.Property<int>("RecomPrice")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.GoodsImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.InsertOutCash", b =>
                {
                    ...
                    b.Property<int>("NewCash")
                        .HasColumnType("int");

                    b.Property<int>("OldCash")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Invoice", b =>
                {
                    ...
                    b.Property<int>("AllInputPrice")
                        .HasColumnType("int");

                    b.Property<int>("AllMarz")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.TypeExpenses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.BackInvoice", b =>
                {
                    ...
                    b.HasOne("Data.GoodsInvoice", "GoodsInvoice")
                        .WithMany()
                        .HasForeignKey("GoodsInvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Data.Expenses", b =>
                {
                    ...
                    b.HasOne("Data.TypeExpenses", "TypeExpenses")
                        .WithMany()
